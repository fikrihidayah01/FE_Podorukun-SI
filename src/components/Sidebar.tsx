  ...
  return (
    <>
      ...
      >
        ...
        <div className="shrink-0 border-t border-gray-100 bg-gray-50/60 p-3 space-y-2">
          {/* User profile card */}
          <div className="flex items-center gap-3 rounded-lg bg-white p-2.5 border border-gray-200/70 shadow-xs">
            ...
            <div className="min-w-0 flex-1">
              ...
              {role && (
                <span
                  className={`mt-1 inline-block rounded-full px-2 py-0.5 text-[10px] font-medium leading-none ${ROLE_BADGE_COLOR[role]}`}
                >
                  {ROLE_LABELS[role]}
                </span>
              )}
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors"
          ...
          <p className="text-[10px] text-gray-400 text-center pt-0.5">SI-Podorukun © 2026</p>
        </div>
      </aside>
    </>
  );

...
export default function CoaPage() {
  ...
  const columns: Column<Akun>[] = [
    ...
    { key: 'namaAkun', label: 'Nama Akun' },
    {
      ...
      label: 'Tipe',
      render: (r) => (
        <span className={`w-32 inline-flex items-center justify-start text-left whitespace-nowrap rounded-full px-3 py-0.5 text-xs font-medium ${TIPE_COLOR[r.tipe]}`}>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main White Card container for Search & Table */}
      <div className="rounded-2xl bg-white p-5 md:p-6 shadow-sm w-full space-y-4">
        {/* Search bar inside #FCFBFC box */}
        <div className="rounded-2xl bg-[#FCFBFC] border border-gray-200 p-3 md:p-3.5">
